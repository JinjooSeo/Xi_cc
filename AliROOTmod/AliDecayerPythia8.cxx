...
void AliDecayerPythia8::ForceMultiHFLS4Upgrade()
{
  ...
  //Omega_cc^+ -> Omega_c pi+
  fPythia8->ReadString("4432:oneChannel = 1 1 0 4332 211");
  fPythia8->ReadString("4432:onMode = off");
  fPythia8->ReadString("4432:onIfAll = 4332 211");

  //Omega_c -> Omega- pi+
  fPythia8->ReadString("4332:oneChannel = 1 1 0 3334 211");
  fPythia8->ReadString("4332:onMode = off");
  fPythia8->ReadString("4332:onIfAll = 3334 211");
...
//   fPythia8->Pythia8()->event.append(pdg, 11, 0, 0, p->Px(), p->Py(), p->Pz(), p->E(), p->M());   
  ...
  Pythia8::Pythia* thePythia       = fPythia8->Pythia8();
  Pythia8::ParticleData& table     = thePythia->particleData;
  Float_t tau0 = table.tau0(pdg);
  fPythia8->Pythia8()->event[0].tau(gRandom->Exp(tau0));
